function AppContainer()
{
    ...
    this.LoadApplication = function (appnumber, param1, param2, param3)
    {
        ChangeApplication(appnumber, param1, param2, param3);
    }
    ...
    function ChangeApplication(appnumber, param1, param2, param3) //called from this.LoadApplication()
    {
        mPauseApp = true;
        mConfig.LoadConfiguration(appnumber, param1, param2, param3);
        mPauseApp = false;
    }
